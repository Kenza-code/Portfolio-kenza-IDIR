# Kenza Idir – Data & Artificial Intelligence Engineer

---

# 👋 Bonjour et bienvenue

Je développe des solutions en **Data**, **Intelligence Artificielle** et **Automatisation** pour aider les entreprises à exploiter leurs données, automatiser leurs processus et intégrer l'IA dans leurs activités.

🎓 **Master 2 Intelligence Artificielle – Université Paris 8**
...
- ⚙️ Automatisation de processus métier
- 🧠 Intelligence Artificielle Générative (LLM)
- 📈 Machine Learning
- 🔗 Intégration d'APIs et création de workflows

---

<p align="center">
<b>⬇ Découvrez mes réalisations ci-dessous ⬇</b>
</p>
